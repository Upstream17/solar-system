...
> **最后更新**：2026-07-12 (v20260712b Moon System 实贴图 — NASA 真实卫星贴图全部接入,20 颗卫星视觉各异)
> **基线 commit**：见 `git log -1`（v20260712b Moon System 实贴图 — 19 颗新卫星用 NASA-3D-Resources 真实贴图）
> **上一基线 commit**：v20260712（Moon System 扩展 — 19 颗新卫星 + 折叠图例 + 滚动）
