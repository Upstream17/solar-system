...
> **最后更新**：2026-07-12 (v20260712d 4 bug fixes — Phobos 缩放锁定 + 缩放上限限制 + Uranus 卫星黑色极区 + 数据参考平面注释)
> **基线 commit**：见 `git log -1`（v20260712d 4 bug fixes）
> **上一基线 commit**：v20260712c（Moon System 贴图质量+加载速度）
...
- **基线 commit**：v20260711d（见 `git log -1`，轨道段数统一 720 段 — 视觉对齐外行星）
